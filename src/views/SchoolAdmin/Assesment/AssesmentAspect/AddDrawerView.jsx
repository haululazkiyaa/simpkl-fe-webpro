...
import { addAspekPenilaian } from "../../../../services/school-admin/assesment-aspect.service.js";
import { refreshToken } from "../../../../services/auth/auth.service.js";
import { toast } from "react-toastify";
import { useNavigate } from "react-router-dom";

export default function AssesmentAspectAddDrawerView(props) {
  const { handleAspekPenilaian, id } = props;
  ...
  const handleTambahTujuanPembelajaran = (e) => {
    ...
    refreshToken((status, token) => {
      if (status) {
        setProgress(60);
        addAspekPenilaian(data, token, (status, message) => {
          if (status) {
  ...
  return (
    <>
      ...
      <Drawer title="Tambah Aspek Penilaian" id={id}>
        {message != "success" ? (
          <form
...
AssesmentAspectAddDrawerView.propTypes = {
