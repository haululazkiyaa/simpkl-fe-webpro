...
import { addJurusan } from "../../../services/school-admin/major-management.service.js";
import { refreshToken } from "../../../services/auth/auth.service.js";
import { toast } from "react-toastify";
import { useNavigate } from "react-router-dom";

export default function MajorManagementAddDrawerView(props) {
  const { handleJurusan, id } = props;
  ...
  const handleTambahJurusan = (e) => {
    ...
    refreshToken((status, token) => {
      if (status) {
        setProgress(60);
        addJurusan(data, token, (status, message) => {
          if (status) {
            toast.success(`Sukses! Jurusan ${bidangKeahlian} ditambahakan.`, {
              autoClose: 3000,
      ...
      <Drawer title="Tambah Jurusan Baru" id={id}>
        {message != "success" ? (
          <form
            ...
            onSubmit={(e) => handleTambahJurusan(e)}
          >
            <Input
              type="text"
...
MajorManagementAddDrawerView.propTypes = {
